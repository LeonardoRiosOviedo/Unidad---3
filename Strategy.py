...
class Strategy:
    ...
    def __init__(self, function=None):
        ...
        #If a reference to a function is provided, replace the execute() method width the given function
...
#Let´s create the first variation of our default strategy by providing anew behavior
